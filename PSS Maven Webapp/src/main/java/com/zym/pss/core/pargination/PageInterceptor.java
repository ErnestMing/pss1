package com.zym.pss.core.pargination;
...
//		}
	...
	private String getOraclePageSql(Page<?> page, StringBuffer sqlBuffer) {
		...
		sqlBuffer.insert(0, "select u.*, rownum r from (").append(" where TENANT_ID = '"+page.getTenantId()).append("') u where rownum < ").append(offset + page.getPageSize());
	...
	private void setTotalRecord(Page<?> page, MappedStatement mappedStatement,
		...
		String countSql = this.getCountSql(sql)	+" where TENANT_ID = '"+page.getTenantId()+"'";		//添加租户ID,查询条件
		// 通过BoundSql获取对应的参数映射
