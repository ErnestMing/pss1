...
<div class="textbox" id="centerTextbox">
    ...
    <div>
		 <table class="commonTable" cellspacing="1">
		 	<input type = "hidden" name = "tenantNo" value = "${obj.tenantNo }"/>
	        <tr>
	            <td class="columnTitle_mustbe">租户编号：</td>
	            <td class="tableContent"><input type="text" name="tenantNo" style="width:200px;" value = "${obj.tenantNo }" disabled="disabled"/></td>
	        </tr>
	        <tr>
