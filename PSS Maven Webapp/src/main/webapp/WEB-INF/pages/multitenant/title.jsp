...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			return formSubmit("${ctx}/tenant.action", "_top");
		}
</script>
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<%--<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		<img src="${ctx}/skin/default/images/title/avataronline.gif" border="0" style="margin-top:-1px;"/>
		 您好：<strong title="${sessionScope.CUR_TENANT.tenantNo}">${sessionScope.CUR_TENANT.tenantNo}</strong>&nbsp;&nbsp;|
	...
	<%-- <a id="memos"  style="cursor:pointer;" href="${ctx}/tenantframe2.action" target="_top" title="点击切换到系统首页"><div id="memo" class="memo" title="点击切换到系统首页"></div></a>
...
<div class="headerBg">
	<div class="top_logo" style="background:url(${ctx}/skin/default/images/login/logo1.gif) no-repeat -2px 2px;">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
			    		<div id="menuContent">
				    		<span id="topmenu" onclick="top.location.href='tenantframe2.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
				    		<span id="topmenu" onclick="top.leftFrame.location.href='infoLeft.action';top.main.location.href='infoMain.action';linkHighlightMenu(this);">租户个人信息</span><span id="tm_separator"></span>
				    		<span id="topmenu" onclick="top.leftFrame.location.href='subsciberLeft.action';top.main.location.href='subsciberMain.action';linkHighlightMenu(this);">服务订购</span><span id="tm_separator"></span>
				    		<span id="topmenu" onclick="top.leftFrame.location.href='userconfLeft.action';top.main.location.href='userconfMain.action';linkHighlightMenu(this);">用户配置</span><span id="tm_separator"></span>
						</div>
					</div>
