...
<li id="enable"><a href="#" onclick="formSubmit('check.action','_self');this.blur();">通过</a></li>
<li id="disable"><a href="#" onclick="formSubmit('checkFail.action','_self');this.blur();">否定</a></li>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			<a href = "${ctx }/cargo/order/check.action?id=${o.id}"><font color="blue">通过</font></a>&nbsp;&nbsp;
			<%-- <c:if test="${o.state == 3}">${orderState["3"] }</c:if> --%><!-- 待审核的订单 -->
			<a href = "${ctx }/cargo/order/checkFail.action?id=${o.id}"><font color="red">否定</font></a>
		</td>
	</tr>
	</c:forEach>
