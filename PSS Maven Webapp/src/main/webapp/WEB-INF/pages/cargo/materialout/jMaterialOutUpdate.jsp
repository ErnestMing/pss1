...
<head>
    <title>修改出库单信息</title>
     ...
     <script type="text/javascript">
 		...
 		function setRepositoryName(opt){
 			 var obj = document.getElementById("repositoryName");
 			 obj.value = opt.text ; 
 		}
     </script>
</head>
    ...
    <div>
		 <table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="pickingPeople"  value="${obj.pickingPeople }"/></td>
	            <td class="columnTitle_mustbe">操作者：</td>
	            <td class="tableContent"><input type="text" name="operator"  value="${obj.operator }"/></td>
	        </tr>
	        <tr>
	        	<td class="columnTitle_mustbe">原材料仓库：</td>
	            <td class="tableAutoContent">
	            	<select name="repositoryNo" onchange="setRepositoryName(this.options[this.selectedIndex])">
						<option value="">----请选择----</option>
	            	...
	            	<!-- 原材料名称 -->
	            	<input type="hidden" name="repositoryName" id = "repositoryName" value="${repositoryName }"/>
	            </td>
