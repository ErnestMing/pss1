    ...
    <div>
		<table class="commonTable" cellspacing="1">
    		<tr>
	            ...
	            <td class="tableContent">${obj.productNo}	/ ${obj.productName }</td>
	            <td class="columnTitle_mustbe">货物数量：</td>
	            <td class="tableContent">${obj.productAmount }/${obj.packingUnit}</td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><fmt:formatDate value="${obj.outTime }" pattern="yyyy-MM-dd"/></td>
	        </tr>
	        <tr>
