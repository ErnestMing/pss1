...
<li id="new"><a href="#" onclick="formSubmit('${ctx }/cargo/productout/start.action','_self');this.blur();">登记</a></li>
<%-- <li id="new"><a href="#" onclick="formSubmit('${ctx }/cargo/productout/cancel.action','_self');this.blur();">取消</a></li> --%>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			...
			<c:if test="${o.state == 0}"><a href = "${ctx }/cargo/productout/start.action?id=${o.id}"><font color="blue">未登记</font></a></c:if>
		</td>
	</tr>
	</c:forEach>
