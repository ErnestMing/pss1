...
<form class="form-horizontal" method="post">
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
	    ...
	    <div class="form-group">
	    <label for="usercode" class="col-sm-4 control-label">验证码:</label>
	    <div class="col-sm-2">
	      <input type="text" class="form-control" id="usercode" name="usercode" placeholder="code">
	    </div>
	    ...
	    <div class="col-sm-4 col-sm-offset-5">
	      <button id = "submit"  class="btn btn-primary" onclick="formSubmit('${ctx}/sysadmin/user/updatepass.action','_self')">Update</button>
	    </div>
	  </div>
	  <br>
	  <div class = "form-group">
