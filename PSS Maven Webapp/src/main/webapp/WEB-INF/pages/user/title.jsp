...
//			alert((0-currLeft) <= maxOffset);
		...
		function logout(){
			return formSubmit("${ctx}/user.action", "_top");
		}
</script>
...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		...
		您好：<strong>${sessionScope.CURUSER.userNo}</strong>&nbsp;&nbsp;|
...
<div class="headerBg">
	<div class="top_logo" style="background:url(${ctx}/skin/default/images/login/logo2.gif) no-repeat -2px 2px;">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
			    		<div id="menuContent">
				    		<span id="topmenu" onclick="top.location.href='userfmain.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
							<c:forEach items="${sessionScope.mainMenu }" var="m">
								<span id="topmenu" onclick="top.leftFrame.location.href='${m.functionURL}Left.action';top.main.location.href='${m.functionURL }Main.action';linkHighlightMenu(this);">${m.functionName }</span><span id="tm_separator"></span>
							</c:forEach>
						</div>
					</div>
