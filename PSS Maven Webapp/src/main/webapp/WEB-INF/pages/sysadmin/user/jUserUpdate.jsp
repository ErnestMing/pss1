...
<div class="textbox" id="centerTextbox">
    ...
    <div>
		 <table class="commonTable" cellspacing="1">
	        <tr>
	        	<input type="hidden" name="userNo" value="${obj.userNo}"/>
	            <td class="columnTitle_mustbe">用户编号：</td>
	            <td class="tableContent"><input type="text" name="userNo" style="width:200px;" value = "${obj.userNo }" disabled="disabled"/></td>
