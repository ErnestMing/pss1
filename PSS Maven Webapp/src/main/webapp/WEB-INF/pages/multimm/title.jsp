...
<div class="headerBg">
	<div class="top_logo" style="background:url(${ctx}/skin/default/images/login/logo0.gif) no-repeat -2px 2px;">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
			    		<div id="menuContent">
				    		<span id="topmenu" onclick="top.location.href='tenantadminframe.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
				    		<span id="topmenu" onclick="top.leftFrame.location.href='tenantadminLeft.action';top.main.location.href='tenantadminMain.action';linkHighlightMenu(this);">租户管理</span><span id="tm_separator"></span>
				    		<span id="topmenu" onclick="top.leftFrame.location.href='servicemanageLeft.action';top.main.location.href='servicemanageMain.action';linkHighlightMenu(this);">服务管理</span><span id="tm_separator"></span>
						</div>
					</div>
