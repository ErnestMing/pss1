    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="supplierNo" /></td>
	            <td class="columnTitle_mustbe">供应商名称：</td>
	            <td class="tableContent"><input type="text" name="supplierName" /></td>
	        </tr>
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="contarcts" /></td>
	        </tr>
	        <tr>
